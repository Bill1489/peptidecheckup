...
export const metadata: Metadata = {
  ...
  description: `Compare up to ${MAX_COMPARE} of ${COMPOUNDS.length} peptides on evidence by goal, regulatory status in your jurisdiction, adverse effects, contraindications, interactions, published human studies and the ${BRAND.displayName} pen that carries each — with combination notes for every pair.`,
